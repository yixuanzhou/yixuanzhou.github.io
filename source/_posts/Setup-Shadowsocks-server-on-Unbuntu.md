---
title: Setup Shadowsocks server on Unbuntu
...
![](Setup-Shadowsocks-server-on-Unbuntu/awsins.png)

After that, you can connect to the instance by simply following the instructions:

![](Setup-Shadowsocks-server-on-Unbuntu/awsconn.png)

A successful connection through SSH should be like this:

![](Setup-Shadowsocks-server-on-Unbuntu/awslog.png)
...
![](Setup-Shadowsocks-server-on-Unbuntu/ssconfig.png)
...
![](Setup-Shadowsocks-server-on-Unbuntu/inbound.png)
...
![](Setup-Shadowsocks-server-on-Unbuntu/ssqt1.png)

Last, try connecting the Shadowsocks server, a successful connection should be like this:

![](Setup-Shadowsocks-server-on-Unbuntu/ssqt0.png)
...
![](Setup-Shadowsocks-server-on-Unbuntu/ubuntunw.png)

## Here we go, Come on!

![](Setup-Shadowsocks-server-on-Unbuntu/gg.png)
