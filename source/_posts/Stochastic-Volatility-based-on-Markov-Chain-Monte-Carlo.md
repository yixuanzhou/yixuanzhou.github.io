...
![](Stochastic-Volatility-based-on-Markov-Chain-Monte-Carlo/prices.png)

![](Stochastic-Volatility-based-on-Markov-Chain-Monte-Carlo/log_change.png)

All sampled h:

![](Stochastic-Volatility-based-on-Markov-Chain-Monte-Carlo/h.png)

The estimated stochastic volatility (mean of all sampled h) and absolute returns ($$|y_t|$$)

![](Stochastic-Volatility-based-on-Markov-Chain-Monte-Carlo/log_volatility.png)

![](Stochastic-Volatility-based-on-Markov-Chain-Monte-Carlo/return.png)
